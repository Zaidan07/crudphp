...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `crud` SET `nama_depan`='$nama_depan',`nama_belakang`='$nama_belakang',`email`='$email',`kelamin`='$kelamin' WHERE id=$id";
      ...
      <form action="" method="post" style="width:50vw; min-width:300px;">
        <div class="row">
            ...
            <div class="from-group mb-3">
                <label>Kelamin:</label> &nbsp;
                <input type="radio" class="form-check-input" name="kelamin" id="male" value="male" <?php echo ($row['kelamin']=='laki-laki')?
                "checked":""; ?>>
                <label for="male" class="form-input-label">Laki-Laki</label>
                &nbsp;
                <input type="radio" class="form-check-input" name="kelamin" id="male" value="female" <?php echo ($row['kelamin']=='perempuan')?
                "checked":""; ?>>
